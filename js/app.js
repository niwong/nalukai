...
$('.column2').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isThree === true) {
			$( "#row3" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Sheridan Hanby</h5><ul class=\"studDet\"><li>—Writing—</li><li>Hawaii Technology Academy</li><li>Junior</li></ul><p>I wish to go into Forensic Anthropology. This field seems disconnected from entrepreneurship, but I believe that by learning these skills and harnessing them I can change the way people view forensic science. A decent amount of forensic science is written off or not taken seriously, and most of this is because of the technology used. By going into the field I not only want to learn about the field itself but also use my skills to evolve the technology within it.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
