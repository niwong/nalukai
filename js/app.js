...
$('.column1').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isTwo === true) {
			$( "#row2" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Keona Conroy-Humphrey</h5><ul class=\"studDet\"><li>—Engineering—</li><li>Lanai High School</li><li>Junior '18</li></ul><p>I have a deep passion for STEM. I was first introduced to STEM in middle school and I immediately fell in love. Not just with the science, technology, engineering and math aspects, but with everything it touched. Programming, digital media, photography, videography, journalism, leadership, and much, much more. The many concepts it covered allowed me to discover my passion, engineering, and fueled my fascination even more. With STEM also came leadership opportunities that helped shaped me as a leader. Leadership is something that help me with my engineering work and vice versa.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isFour === true) {
			$( "#row4" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Kiana Liu</h5><ul class=\"studDet\"><li>—Videography—</li><li>Kamehameha Maui High School</li><li>Sophomore '19</li></ul><p>I realized my passion was photography at this place called Hana in Maui. I was camping with my family and I had an old camera from my mom that I was using. We were super disconnected from the cities, away from technology, without wifi. All I could do was take pictures. So I took pictures of random things like nature. One day we went to the waterfalls, and just saw this stunning waterfall with a rainbow in front. It was so beautiful I wanted to capture it. Everything just clicked, like “that’s my passion, this is what I’m here for, this is why I’m on Earth” and everything else disappeared. It was a magical moment.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
...
$('.column2').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isOne === true) {
			$( "#row1" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Aya Chang</h5><ul class=\"studDet\"><li>—Photography—</li><li>Kamehameha Kapalama</li><li>Junior '18</li></ul><p>If I were to choose just one thing I’m interested in, it would be photography because of its ability affect peoples’ emotions. Photography has the unique ability to communicate in the way that words can’t. As you experience the world with photography, over time you develop an innate ability to recognize the best way to capture an image. After being exposed to photography, I’ve started to perceive life in an entirely different way. Small interactions between people have become more apparent–a glance between strangers, a laugh exchanged between a couple. I’ve learned to notice the light reflecting off of the trees at sunset.  I’ve finally begun to appreciate the beauty that is our world.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isThree === true) {
			$( "#row3" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Sheridan Hanby</h5><ul class=\"studDet\"><li>—Writing—</li><li>Hawaii Technology Academy</li><li>Junior '18</li></ul><p>I wish to go into Forensic Anthropology. This field seems disconnected from entrepreneurship, but I believe that by learning these skills and harnessing them I can change the way people view forensic science. A decent amount of forensic science is written off or not taken seriously, and most of this is because of the technology used. By going into the field I not only want to learn about the field itself but also use my skills to evolve the technology within it.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isSix === true) {
			$( "#row6" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Julia Smith</h5><ul class=\"studDet\"><li>—Programming/Photography—</li><li>West Hawaii Explorations Academy</li><li>Junior '18</li></ul><p> I’m a jack of all trades, I love learning new hobbies and expanding my skill set. This is useful when connecting and communicating with people. However, the one constant interest I have is photography. Capturing emotions and moments in time is my passion. Being a self taught photographer, I’m always looking for ways to optimize my images and manipulate my surrounding to get the best possible outcome.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
...
$('.column3').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isOne === true) {
			$( "#row1" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Jasmine Conroy-Humphrey</h5><ul class=\"studDet\"><li>—Engineering—</li><li>Lanai High School</li><li>Junior '18</li></ul><p>For the past three years, my school has actively focused on science, technology, engineering, and mathematics. I feel like STEM is a field where I really fit in. I go to an after school program to work on projects of my choice and we go to an annual STEM conference on Maui where we showcase our projects we’ve been working on over the last year. Being a part of STEM has given me the opportunity to be a part of some incredible projects with equally incredible people.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isSix === true) {
			$( "#row6" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Emiley Stallings</h5><ul class=\"studDet\"><li>—Writing/Gray Hat—</li><li>BYU Independent Study</li><li>Sophomore '19</li></ul><p>My passion started when I was placed as the head programmer on my robotics team. Fortunately, I’ve had some exposure to the design experience from helping out with app designs. I’m considered to be an open minded person and willing to work with everyone in anyway I can. In the middle of this camp, one of the mentors suggested that I should learn Xcode, and the experience of teaching myself this programming language has been amazing. In the future, I wish  to create an app for iOS that users would genuinely enjoy.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");
