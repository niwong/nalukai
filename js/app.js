...
$('.column2').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isOne === true) {
			$( "#row1" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Aya Chang</h5><p>If I were to choose just one thing I’m interested in, it would be photography because of its ability affect peoples’ emotions. Photography has the unique ability to communicate in the way that words can’t. As you experience the world with photography, over time you develop an innate ability to recognize the best way to capture an image. After being exposed to photography, I’ve started to perceive life in an entirely different way. Small interactions between people have become more apparent–a glance between strangers, a laugh exchanged between a couple. I’ve learned to notice the light reflecting off of the trees at sunset.  I’ve finally begun to appreciate the beauty that is our world.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isThree === true) {
			$( "#row3" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Sheridan Hanby</h5><p>I wish to go into Forensic Anthropology. Forensic Anthropology seems disconnected from entrepreneurship, but I believe that by learning these skills and harnessing them I can change the way people view forensic science. A decent amount of forensic science is written off or not taken seriously, and most of this is because of the technology used. By going into the field I not only want to learn about the field itself but also use my skills to evolve the technology within it.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isFour === true) {
			$( "#row4" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Leilani Maui</h5><p>I really enjoy learning about programming. It was my first experience with coding and I like I have power and control when I use it. Whatever it was that I type is exactly what happens. I can make my own little world in my own way. I love coding and decided to keep pursuing it in programming.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		if (isSix === true) {
			$( "#row6" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Julia Smith</h5><p>With my first robotics program I was hooked. All it said was: print “Hello World.” It amazed me, this simple piece of code, code I never thought I’d be able to write. Afterwards, I read everything I could about coding. I practiced, practiced, and practiced some more. I got so into it that I taught myself how to program an FRC robot, and started looking into other programming languages. I know now, no matter what I decide to do in my future career, these skills will benefit me</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
...
$('.column3').click(function() {
	...
	if (i % 2 === 0) {
		...
		if (isOne === true) {
			$( "#row1" ).after("<div class=\"callout\" id=\"studInfo\"><h5 class=\"names\">Jasmine Conroy-Humphrey</h5><p>For the past three years, my school has actively focused on science, technology, engineering, and mathematics. I feel like STEM is a field where I really fit in. I go to an after school program to work on projects of my choice and we go to an annual STEM conference on Maui where we showcase our the projects we’ve been working on over the last year. Being a part of STEM has given me the opportunity to be a part of some incredible projects with equally incredible people.</p></div>" );
			$("#studInfo").before("<div class=\"triangle\"</div>");	
