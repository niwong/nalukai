...
$('.column2').click(function() {
	...
	if (i % 2 === 0) {
		...
		// }
		// if (isThree === true) {
		// 	$( "#row3" ).after("<div class=\"callout\" id=\"studInfo\"><h5>Sheridan Hanby</h5><p>I wish to go into Forensic Anthropology. Forensic Anthropology seems disconnected from entrepreneurship, but I believe that by learning these skills and harnessing them I can change the way people view forensic science. A decent amount of forensic science is written off or not taken seriously, and most of this is because of the technology used. By going into the field I not only want to learn about the field itself but also use my skills to evolve the technology within it.</p></div>" );
		// 	$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		// }
		// if (isFour === true) {
		// 	$( "#row4" ).after("<div class=\"callout\" id=\"studInfo\"><h5>Leilani Maui</h5><p>I really enjoy learning about programming. It was my first experience with coding and I like I have power and control when I use it. Whatever it was that I type is exactly what happens. I can make my own little world in my own way. I love coding and decided to keep pursuing it in programming.</p></div>" );
		// 	$("#studInfo").before("<div class=\"triangle\"</div>");	
		...
		// }
		// if (isSix === true) {
		// 	$( "#row6" ).after("<div class=\"callout\" id=\"studInfo\"><h5>Julia Smith</h5><p>With my first robotics program I was hooked. All it said was: print “Hello World.” It amazed me, this simple piece of code, code I never thought I’d be able to write. Afterwards, I read everything I could about coding. I practiced, practiced, and practiced some more. I got so into it that I taught myself how to program an FRC robot, and started looking into other programming languages. I know now, no matter what I decide to do in my future career, these skills will benefit me</p></div>" );
		// 	$("#studInfo").before("<div class=\"triangle\"</div>");	
